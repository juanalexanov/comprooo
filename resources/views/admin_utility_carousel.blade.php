...
<head>
    ...
    <title>Lumina Admin - Edit Carousel</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Edit Carousel</h1>
                        ...
                        <div class="container mt-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="/admin/cms/carousel/create" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="titlecarousel">
                                        </div>
                                        <div class="mb-3">
                                            <label for="desccarousel">Description</label>
                                            <textarea class="form-control" rows="3" name="desccarousel"></textarea>
                                        </div>
                                                ...
                                                @foreach ($datacarousel as $item)
                                                    <tr id = "{{$item->id}}">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="/admin/cms/carousel/delete/{{$item->id}}" class="btn btn-danger btn-circle">
                        ...
                        <form action="" method="post" id = "form-update-displaybanner" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="titlecarouselmodal" id = "db-title">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Description</label>
                                    <input type="text" class="form-control" name="desccarouselmodal" id = "db-description">
                                </div>
                            </div>
    ...
    <script>
        ...
        $('#form-update-displaybanner').prop('action',"/admin/cms/carousel/update/"+$(this).closest('tr').attr('id'));
