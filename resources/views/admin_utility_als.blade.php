...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Edit All License Software</h1>
                    ...
                    <div class="row">
                        <div class="container mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <header>
                                        <h3>Add All License Software</h3>
                                    </header>
                                    <hr style="margin: 1rem -1rem;" />
                                    <form action="/admin/cms/als/create" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Update License Software</h5>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; PT. Lumina Eka Optima 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script>
        ...
        $('#form-update-displaybanner').prop('action',"/admin/cms/als/update/"+$(this).closest('tr').attr('id'));
