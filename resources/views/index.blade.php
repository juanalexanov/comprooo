...
<body>
    ...
    <div class="listkartu container mx-auto px-20">
        <h2 class="m-auto text-4xl font-normal text-gray-900 dark:text-white">Featured insights</h2>
        <div class="mt-11 grid md:grid-cols-3 gap-4">
            <!-- Card 1 -->
            <div class="boxx bg-white shadow-xl overflow-hidden">
                <img src="{{ asset('img/cardsection.jpg') }}" alt="Featured insight" class="w-full h-96 object-cover" />
                <div class="p-4">
                    <h3 class="font-bold text-lg mb-2">Prepare now for the new era of globalization</h3>
            ...
            <!-- Card 2 -->
            <div class="boxx bg-white shadow-xl overflow-hidden">
                <img src="{{ asset('img/cardsection.jpg') }}" alt="Technology and ambitions"
                    class="w-full h-96 object-cover" />
                <div class="p-4">
                    <h3 class="font-bold text-lg mb-2">Is your technology moving fast enough to realize your ambitions?
                    </h3>
                    <p class="text-gray-700 text-base">
            ...
            <!-- Card 3 -->
            <div class="boxx bg-white shadow-xl overflow-hidden">
                <img src="{{ asset('img/cardsection.jpg') }}" alt="Transformation success"
                    class="w-full h-96 object-cover" />
                <div class="p-4">
                    <h3 class="font-bold text-lg mb-2">How do you harness the power of people to double transformation
                        success?</h3>
                    <p class="text-gray-700 text-base">
    ...
    <section class="bg-white dark:bg-white">
        <div
            ...
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-black dark:text-black">Let's create more
                    tools and ideas that brings us together.</h2>
                <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-500">Flowbite helps you connect with
                ...
                <a href="#"
                    class="inline-flex items-center rounded-lg bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Get
                    Started
                ...
                {{-- <a href="#"
                    class="inline-flex items-center text-white bg-primary-500 hover:bg-black-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                    Get started
                    <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
    ...
    <section class="bg-white dark:bg-white">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black-400">We didn't
                    reinvent the wheel</h2>
                <p class="mb-4 text-gray-500">We are strategists, designers and developers. Innovators and problem
                    solvers. Small enough to be simple and quick, but big enough to deliver the scope you want at the
                    pace you need. Small enough to be simple and quick, but big enough to deliver the scope you want at
                    the pace you need.</p>
                <p class="text-gray-500">We are strategists, designers and developers. Innovators and problem solvers.
                    Small enough to be simple and quick.</p>
            </div>
            ...
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com" class="flex items-center">
                        ...
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-gray-600">Flowbite</span>
                    </a>
                </div>
